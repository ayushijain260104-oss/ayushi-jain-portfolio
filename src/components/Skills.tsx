...
export default function Skills() {
  return (
    <div>
      <div className="mb-20">
        <span className="text-ink/60 font-medium tracking-widest uppercase text-xs mb-8 block">Expertise</span>
        <div className="max-w-3xl">
          <h2 className="text-4xl md:text-6xl font-serif text-ink leading-[1.1] mb-8">
            I enjoy working at the intersection of{' '}
            <RotatingText 
              texts={['insight', 'strategy', 'storytelling', 'culture']} 
              className="text-ink italic"
              interval={2500}
            />
          </h2>
          <p className="text-xl text-ink/70 font-serif italic leading-relaxed mb-4">
            From understanding consumer behavior to shaping ideas and campaigns, I focus on creating work that feels relevant, thoughtful, and meaningful.
          </p>
          <p className="text-sm text-ink/40 font-light tracking-wide uppercase">
            I’m less focused on tools, and more on why something works.
          </p>
        </div>
      </div>
